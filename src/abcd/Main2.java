...
*/
        ...
        finalEndPoints.add("<abcd.MathRealTest: void testsum()>");
        finalEndPoints.add("<abcd.MathRealTest: void testsum2()>");

        //finalEndPoints.add("<abcd.MathRealTest2: void firstTest()>");
        ...
        for (String ep: finalEndPoints             ) {
            ...
            libPath +=  sep + "/home/ubuntu/research/checkReduce/lib/hamcrest-core-1.3.jar";

            libPath +=  sep + "/home/ubuntu/research/checkReduce/lib/ant-testutil.jar";
            ...
            sources.add("<abcd.Math: java.lang.String changeValue3(java.lang.String)>");


            sinks.add("<junit.framework.Assert: void assertEquals(int,int)>");
           // sinks.add("<junit.framework.TestCase: void assertTrue(boolean)>");
            sinks.add("<junit.framework.Assert: void assertTrue(boolean)>");
            sinks.add("<org.apache.tools.ant.AntAssert: void assertContains(java.lang.String,java.lang.String)>");
       ...
       // }
        ...
        sClass = SootLoader.load("abcd.Math");
        Iterator it = testMethods.iterator();
        while(it.hasNext()){
            TestMethodInfo tm = (TestMethodInfo) it.next();
            for (SootMethodRef m2: tm.methodRefs
                 ) {
                if(m2.toString().equals("<abcd.Math: int max(int,int,int)>")) {
                    MethodAnalyzer2 analyzer = new MethodAnalyzer2(sClass,tm.methodRefs,tm.classVariableRefs,tm.assertRefs, "max");
                    analyzer.Analyze();
                }
